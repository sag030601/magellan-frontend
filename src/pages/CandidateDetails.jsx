...
const FORMS_CATALOG = {
  cv_company_owner: [
    ...
    { key: "aramco_cv", name: "Aramco (CV Form)", canPreview: false, canDownload: false, status: "unavailable" },
  ],
  pre_joining_seafarers: [
    ...
    { key: "drug_alcohol_declaration", name: "Drug & Alcohol Declaration Form", canPreview: true, canDownload: true, status: "generated" },
    { key: "marpol_declaration", name: "MARPOL - Read and Understood Declaration", canPreview: true, canDownload: true, status: "generated" },
    { key: "nda_policy", name: "Non-Disclosure Agreement (NDA) Policy", canPreview: true, canDownload: true, status: "generated" },
    { key: "cyber_security_policy", name: "Cyber Security Policy", canPreview: true, canDownload: true, status: "generated" },
    { key: "anti_smuggling_awareness", name: "Anti-Smuggling Awareness", canPreview: true, canDownload: true, status: "generated" },
    { key: "bank_account_declaration", name: "Bank Account Declaration Form", canPreview: true, canDownload: true, status: "generated" },
  ],
  sea_rpsl_contract: [
  ...
  pre_departure: [],
  sea_service_letters: [
    { key: "sea_service_standard", name: "Sea Service Letter (Standard)", canPreview: true, canDownload: true, status: "generated" },
    { key: "sea_service_gmdss_renewal", name: "Sea Service Letter for GMDSS Renewal", canPreview: true, canDownload: true, status: "generated" },
    { key: "sea_service_coc_renewal", name: "Sea Service Letter for CoC Renewal", canPreview: true, canDownload: true, status: "generated" },
    { key: "sea_service_watchkeeping_ii4_deck", name: "Sea Service Letter for issuance of Watch-Keeping II/4 (Deck)", canPreview: true, canDownload: true, status: "generated" },
    { key: "sea_service_watchkeeping_iii4_engine", name: "Sea Service Letter for issuance of Watch-Keeping III/4 (Engine)", canPreview: true, canDownload: true, status: "generated" },
    { key: "sea_service_cop_ii5_deck", name: "Sea Service Letter for issuance of CoP II/5 (Deck)", canPreview: true, canDownload: true, status: "generated" },
    { key: "sea_service_cop_iii5_engine", name: "Sea Service Letter for issuance of CoP III/5 (Engine)", canPreview: true, canDownload: true, status: "generated" },
  ],
  full_cv_package: [
